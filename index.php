...
<main class="app-body" style="padding: 4px 0 85px 0; background: transparent; display: flex; flex-direction: column; justify-content: space-between; flex: 1; min-height: 0;">
